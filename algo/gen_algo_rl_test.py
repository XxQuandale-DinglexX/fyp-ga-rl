...
import time
from algo.gen_algo import GeneticAlgorithm
...
class RLGeneticAlgorithm(GeneticAlgorithm):
    ...
    def apply_action(self, action: int, population: List[np.ndarray]):
        ...
        Example mapping (8 actions):
          ...
          2: decrease mutation rate
          3: increase crossover rate
          4: decrease crossover rate
          5: increase local search probability
          6: decrease local search probability
          7: cycle mutation strategy (Gaussian -> Cauchy -> Polynomial -> Gaussian)
        """
        ...
        if action == 0:
            ...
            # optional: move params slightly back toward defaults
