    ...
    def create_initial_population(self) -> List[np.ndarray]:
        ...
        for _ in range(self.population_size):
            ...
            for i, machine in enumerate(self.machines):
                ...
                # Restrict to only 90 degree factor rotations
                rotation = round(random.uniform(0, 360)/90)*90
    ...
    def optimize(self) -> Tuple[List[Machine], float, Dict]:
        ...
        for generation in range(self.generations):
            ...
            if generation % 10 == 0:
                ...
                current_best_machines.append(best_solution)
        ...
        # First decode all chromosomes
        decoded_machines_list = []
        for chromosome in current_best_machines:
            decoded_machines = self.decode_chromosome(chromosome)
            decoded_machines_list.append(decoded_machines)
        
        decoded_machines_list.append(final_machines)
